...
// */
public class EditDishMenuCommand implements Command {
    private static final Logger LOG = LogManager.getLogger(EditDishMenuCommand.class);
    @SuppressWarnings("FieldMayBeFinal")
    private DishService dishService;

    public EditDishMenuCommand() {
