...
([function(t,e,n){
    ...
    function v(t){
        ...
        r[t]&&m(r[t]);
        var i=r[t]=e(s,d,n)||{};
        return v(i),i},i.require=function(t){
            return r[t]
        },i.push=function(t){
            h?l(t)&&t():a.push(t)
        },i.env=function(t){
        ...
        function e(t,e){
            ...
            function r(t){
                ...
                return h.constructor=c,c.mixin=function(e){
                    return l[t]=c[t]=i(c,e)[t],c},c.open=function(t){
                        if(d={},o(t)?d=t.call(c,h,f,c,s):r(t)&&(d=t),r(d))
                            for(var n in d)e.call(d,n)&&(h[n]=d[n]);
                        return o(h.init)||(h.init=s),c},c.open(u)
                }
            ...
            ease:["ease",function(t,e,n,i){
                ...
                var r=(t/=i)*t,o=r*t;
                return e+n*(2*o*r+-5*r*r+2*o+2*r)}],linear:["linear",function(t,e,n,i){
                    return n*t/i+e
                    ...
                    A=function(t){
                        ...
                        if(L.transition){
                            ...
                            function n(e,n){
                                ...
                                return i.el||i.init(e),n?i.start(n):i}e.init=function(e,i){
                                    var r=t(e);
                            ...
                            function n(t,e){
                                ...
                                for(n in t)r=(o=Q[n])[0],i=o[1]||n,
                                    ...
                                    e.call(this,i,a,r)}t.init=function(){
                            ...
                            e.fallback=function(t){
                                if(!L.transition)
                                    return H.fallback=!0;
                                H.agentTests.push("("+t+")");
                                var e=new RegExp(H.agentTests.join("|"),"i");H.fallback=e.test(navigator.userAgent)},e.fallback("6.0.[2-5] Safari"),e.tween=function(t){
                                return new U(t)},e.delay=function(t,e,n){
                                ...
                                var X=t.style,Z=t.css,G={
                                    ...
                                    opacity:[q,w],top:[q,x],right:[q,x],bottom:[q,x],left:[q,x],
                                        ...
                                        "line-height":[q,_],"scroll-top":[N,w,"scrollTop"],"scroll-left":[N,w,"scrollLeft"]},Q={};
