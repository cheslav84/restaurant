...
<html data-wf-domain="easy-times.webflow.io" data-wf-page="55d5c046965aff177731c33f"
      ...
      class="w-mod-js wf-merriweather-n3-active wf-merriweather-i3-active wf-merriweather-n4-active wf-merriweather-i4-active wf-merriweather-n7-active wf-merriweather-i7-active wf-merriweather-n9-active wf-merriweather-i9-active wf-oswald-n5-active wf-oswald-n3-active wf-oswald-n2-active wf-oswald-n4-active wf-oswald-n7-active wf-oswald-n6-active wf-lato-n1-active wf-lato-i1-active wf-lato-n3-active wf-lato-n4-active wf-lato-i3-active wf-lato-i4-active wf-lato-i7-active wf-lato-n7-active wf-lato-n9-active wf-lato-i9-active wf-droidsans-n4-active wf-droidsans-n7-active wf-opensans-n3-active wf-opensans-n4-active wf-opensans-n7-active wf-opensans-n6-active wf-opensans-n8-active wf-opensans-i4-active wf-opensans-i8-active wf-opensans-i7-active wf-opensans-i3-active wf-opensans-i6-active wf-satisfy-n4-active wf-reeniebeanie-n4-active wf-active">
<head>
...
<div id="top" class="page-header wf-section">
    <div class="page-header-overlay menu">
        <div class="container w-container">
            <div class="section-intro-block"><h2 data-ix="fade-in-on-load" class="section-intro-title">Our menu</h2>
                <h2 data-ix="fade-in-on-load-2" class="section-intro-title subtitle">Select menu below:</h2></div>
        </div>
    </div>
</div>
    ...
    <div class="container w-container">
        <div data-duration-in="300" data-duration-out="100" data-current="Coffee" data-easing="ease"
            ...
            <div class="menu-page-tabs-menu w-tab-menu">
                <a data-w-tab="All" data-ix="fade-in-on-load-7"
                   class="menu-page-tab-button w-inline-block w-clearfix w-tab-link">
                    ...
                    <select name="sort-menu-by" class="menu-page-tab-title subtitle">Sort by
                        <option value="Name">Name</option>
                        <option value="Price">Price</option>
                        <option value="Category">Category</option>
                    </select>
                </a><a data-w-tab="Coffee" data-ix="fade-in-on-load-3"
